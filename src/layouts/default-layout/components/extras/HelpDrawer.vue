        ...
        >
          ...
          >
            ...
            <h2 class="fw-bold mb-5">
              Support at
              <a href="https://devs.back2bet.io" class=""
                >devs.back2bet.io</a
              >
            </h2>
            <!--end::Heading-->
            ...
            <div class="fs-5 fw-semibold mb-5">
              ...
              <a
                ...
                href="https://back2bet.io/licensing"
                >FAQs</a
              >
            </div>
            <!--end::Description-->
          ...
          <div class="d-flex align-items-center mb-7">
            ...
            <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
              ...
              <div class="d-flex flex-column me-2 me-lg-5">
                <!--begin::Title-->
                <a
                  href="https://preview.back2bet.io/metronic8/vue/docs/getting-started/build"
          ...
          <div class="d-flex align-items-center mb-7">
            ...
            <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
              ...
              <div class="d-flex flex-column me-2 me-lg-5">
                <!--begin::Title-->
                <a
                  href="https://preview.back2bet.io/metronic8/vue/docs/base/utilities"
                  class="text-gray-900 text-hover-primary fw-bold fs-6 fs-lg-4 mb-1"
          ...
          <div class="d-flex align-items-center mb-7">
            ...
            <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
              ...
              <div class="d-flex flex-column me-2 me-lg-5">
                <!--begin::Title-->
                <a
                  href="https://preview.back2bet.io/metronic8/vue/docs/getting-started/changelog"
                  class="text-gray-900 text-hover-primary fw-bold fs-6 fs-lg-4 mb-1"
                  >What's New</a
                >
                <!--end::Title-->
