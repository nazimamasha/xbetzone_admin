...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
...

      {
        path: "/users",
        name: "users",
        component: () => import("@/views/users-partners/Users.vue"),
        meta: {
          pageTitle: "Users",
          breadcrumbs: ["Users"],
        },
      ...
      },
      {
        path: "/agents",
        name: "agents",
        component: () => import("@/views/users-partners/Partners.vue"),
        meta: {
          pageTitle: "Partners",
      ...
      },
      {
        path: "/deposits",
        name: "deposits",
        component: () => import("@/views/deposits-withdraws/Deposits.vue"),
        meta: {
          pageTitle: "Deposits",
      ...
      },
      {
        path: "/withdraws",
        name: "withdraws",
        component: () => import("@/views/deposits-withdraws/Withdraws.vue"),
        meta: {
          pageTitle: "Withdraws",
      ...
      },
      {
        path: "/games/casino",
        name: "games-casino",
        component: () => import("@/views/games/Casino.vue"),
        meta: {
          pageTitle: "Casino",
          breadcrumbs: ["Games", "Casino"],
        },
      },
      {
        path: "/bets/sports",
      ...
      },
      {
        path: "/bets/casino",
        name: "bets-casino",
        component: () => import("@/views/bets/Casino.vue"),
        meta: {
...

      {
        path: "/logs/usermoney",
        name: "logs-usermoney",
        component: () => import("@/views/logs/UserMoneyLog.vue"),
        meta: {
          pageTitle: "User Balance Log",
          breadcrumbs: ["Logs", "Users Balance Log"],
        },
      },

      {
        path: "/logs/agentmoney",
        name: "logs-agentmoney",
        component: () => import("@/views/logs/AgentMoneyLog.vue"),
        meta: {
          pageTitle: "Agents Balance Log",
          breadcrumbs: ["Logs", "Agents Balance Log"],
        },
      },
      {
        path: "/reports",
