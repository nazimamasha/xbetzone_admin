      ...
      <div class="card-toolbar">
        <div class="d-flex justify-content-end">
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Football,
            }"
            @click="onSport(SportsIDs.Football)"
          >
            Football
          </button>
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Baseball,
            }"
            @click="onSport(SportsIDs.Baseball)"
          >
            Baseball
          </button>
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Basketball,
            }"
            @click="onSport(SportsIDs.Basketball)"
          >
            Basketball
          </button>
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Volleyball,
            }"
            @click="onSport(SportsIDs.Volleyball)"
          >
            Volleyball
          </button>
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Hockey,
            }"
            @click="onSport(SportsIDs.Hockey)"
          >
            Hockey
          </button>
          <button
            ...
            class="btn me-3"
            :class="{
              'btn-light-primary': listQuery.sportId === SportsIDs.Others,
            }"
            @click="onSport(SportsIDs.Others)"
          >
            Others
          </button>
        </div>
      ...
      >
        ...
        <template v-slot:actions="{ row: game }">
          <button
            ...
            @click="marketsModalRef.setGame(SportsType.PREMATCH, game)"
          >
            Markets
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSport = (sport: SportsIDs) => {
      listQuery.value.sportId = sport;
      getList();
    };
    const onSearch = () => {
      getList();
