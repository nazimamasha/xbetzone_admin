<template>
  <div class="table-responsive mb-4">
    <table
      ...
      class="fs-6 dataTable no-footer"
    >
      <TableBodyRow
        v-if="data.length !== 0"
      ...
      <template v-else>
        <tr class="odd">
          <td colspan="7" class="dataTables_empty h-50px">
            {{ emptyTableText }}
          </td>
        </tr>
      </template>
...
import TableHeadRow from "@/components/bet-datatable/table-partials/table-content/table-head/TableHeadRow.vue";
import TableBodyRow from "@/components/bet-datatable/table-partials/table-content/table-body/TableBodyRow.vue";
import Loading from "@/components/bet-datatable/table-partials/Loading.vue";
import type { Sort } from "@/components/bet-datatable/table-partials/models";
