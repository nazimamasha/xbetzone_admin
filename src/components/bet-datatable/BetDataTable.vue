...
import TableContent from "@/components/bet-datatable/table-partials/table-content/TableContent.vue";
import TableFooter from "@/components/bet-datatable/table-partials/TableFooter.vue";
