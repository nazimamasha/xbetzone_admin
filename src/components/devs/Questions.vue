...
export default defineComponent({
  ...
  setup() {
    const questions = ref<Array<IQuestion>>([
      {
        title: "How to use Back2Bet with Django Framework ?",
        summary:
      ...
      },
      {
        ...
        summary:
          "could not get demo7 working from latest back2bet version. Had a lot of issues installing, I had to downgrade my npm to 6.14.4 as someone else recommended here in the comments, this goot it to compile but when I ran it, the browser showed errors TypeErr..",
      ...
      },
      {
        ...
        summary:
          "Your Back2Bet theme is so good but the reactjs version is typescript only. The description did not write any warn about it. Since I only know javascript, I can not do anything with your theme. I want to refund.",
        author: "Alex Bold",
        date: "1 day ago",
      ...
      {
        title: "How to integrate Back2Bet with Blazor Server Side ?",
        summary:
          "could not get demo7 working from latest back2bet version. Had a lot of issues installing, I had to downgrade my npm to 6.14.4 as someone else recommended here in the comments, this goot it to compile but when I ran it, the browser showed errors TypeErr..",
        author: "Tim Nilson",
        date: "3 days ago",
      ...
      {
        title: "Using Back2Bet with .NET multi tenant application",
        summary:
          "When approx. is the next update for the Laravel version planned? Waiting for the CRUD, 2nd factor etc. features before starting my project. Also can we expect the Laravel + Vue version in the next update ?",
        author: "Ana Quil",
        date: "5 days ago",
